#!/usr/bin/env python3
"""Train full unfrozen DINOv2-Reg (SupCon / ArcFace) on quill RID-holdout pool.

  bash symbol_embed/run_verify_dataset.sh
  python -m symbol_embed.scripts.train_dino_full --arm both
"""
...
from symbol_embed.dino_full_model import DinoFullModel
...
def main() -> None:
    ...
    for arm in arms:
        train_backbone_arm(
            ...
            pool_dir,
            cfg,
            model_factory=DinoFullModel,
            run_family="dino_full",
            paths=paths,
        )
